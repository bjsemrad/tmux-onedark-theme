...
set "status-right" "#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_yellow,bg=$onedark_yellow] #[fg=$onedark_black,bg=$onedark_yellow,bold] #S "

set "status-left" "#[fg=$onedark_black,bg=$onedark_green,bold] #{?client_prefix,TMUX,NORMAL} "
