...
set "status-left" "#{?client_prefix,#[noreverse]Prefix#[reverse] ,} #[fg=$onedark_black,bg=$onedark_blue,bold] #[fg=$onedark_black,bg=$onedark_green,bold] #S #{prefix_highlight}#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
