...
set "status-right" "#[fg=$onedark_purple,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_purple,bold] #h #[fg=$onedark_yellow, bg=$onedark_purple]#[fg=$onedark_yellow,bg=$onedark_yellow]#[fg=$onedark_black,bg=$onedark_yellow,bold]#S "
...
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_blue,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_blue,nobold] #I  #W #[fg=$onedark_black,bg=$onedark_blue,nobold,nounderscore,noitalics]"
