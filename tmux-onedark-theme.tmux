...
set "status-left" "#[fg=$onedark_black,bg=$onedark_blue,bold]#{?client_prefix,#[reverse]<Prefix>#[noreverse] ,}#[fg=$onedark_black,bg=$onedark_green,bold]#S #{prefix_highlight}#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
