...
set "status-left" "#{?client_prefix,#[fg=$onedark_blue,bg=$onedark_black,bold]Prefix#[fg=$onedark_black,bg=$onedark_blue,bold];,} #[fg=$onedark_black,bg=$onedark_green,bold] #S #{prefix_highlight}#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
