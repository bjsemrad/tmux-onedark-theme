...
set "status-left" "#[fg=$onedark_blue,bg=$onedark_black,bold] #{?client_prefix,#[noreverse]Prefix#[noreverse] ,} #[fg=$onedark_black,bg=$onedark_green,bold] #S #{prefix_highlight}#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
